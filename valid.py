...
def model_valid(model_path=None,
                model_type='effnet',
                re_size=300,
                tta_flag=True,
                model_output='regression',
                valid_data_root=r'./data/isbi',
                df=None):
    K.clear_session()
...
if __name__ == "__main__":
    ...
    for k, v in models.items():
        print(k)
        outs = model_valid(v[0], v[1], v[2], v[3], v[4], isbi_root, df)
        result[k] = outs
